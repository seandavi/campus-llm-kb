...
The pharmacovigilance analogy is useful here. A drug approved by the FDA carries a post-market surveillance obligation: the manufacturer must monitor for adverse events that did not appear in the clinical trials. AI/ML-based Software as a Medical Device is now subject to analogous requirements. The FDA’s lifecycle-management guidance for AI-enabled device software functions, issued in draft in January 2025, remains a draft as of August 2026, but the agency’s direction is clear: ongoing performance monitoring and active surveillance for drift and bias are expected elements of any clinical AI program ([U.S. Food and Drug Administration 2025](#ref-FDA2025-lifecycle)). The finalized Predetermined Change Control Plan guidance already binds the premarket side of the same lifecycle ([U.S. Food and Drug Administration 2024](#ref-FDA2024-pccp)). Flag this as an area to check; the lifecycle guidance may be final by the time you read this.
...
The most important education monitoring KPI is assessment validity: does the assessment format still distinguish students who have developed genuine clinical reasoning from students who have not? This is a question for faculty, not for a dashboard. ACGME’s Common Program Requirements do not yet name AI competency; the topic appears in the accreditor’s stakeholder survey for the next major revision, not in the current requirements ([Accreditation Council for Graduate Medical Education 2026](#ref-ACGME2025-CPR)). Until an accreditor requirement lands, the monitoring obligation is one the institution sets for itself — and a program that builds assessment-validity monitoring now will be ahead of the requirement if and when it arrives.

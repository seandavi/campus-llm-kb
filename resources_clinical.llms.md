...
By 2026, three-quarters of U.S. health systems report using at least one AI application, up from 59 percent the year before ([Fierce Healthcare 2026](#ref-FierceHealthcare2026-adoption)). Cleveland Clinic’s 2025 expanded rollout of Bayesian Health’s sepsis detection platform shows what that adoption looks like when the validation work comes first. The underlying system was studied prospectively across five hospitals and 590,736 monitored patients, where it caught 82 percent of sepsis cases, drew a provider response to 89 percent of its alerts, and cut median time to first antibiotic order by 1.85 hours when a provider confirmed the alert within three hours ([Adams et al. 2022](#ref-Adams2022-trews); [Henry et al. 2022](#ref-Henry2022-trews-adoption)). Cleveland Clinic then ran its own pilot at Fairview Hospital before expanding, reporting a 46 percent increase in identified cases and a ten-fold drop in false alerts across more than 3,330 patients ([Cleveland Clinic 2025](#ref-ClevelandClinic2025-sepsis)). The sequence matters more than any single number: published multi-site evidence first, local validation second, expansion third. The more common pattern is the reverse, with tools deployed on vendor-reported accuracy that does not hold at the deploying institution and governance questions deferred until after the gap shows up in patient outcomes.
...
| CMS | Medicare Advantage regulations (42 CFR 422.101(c)), applied to AI by HPMS memorandum | February 2024 | Medical necessity determinations must rest on the individual patient’s circumstances; an algorithm working from a larger data set cannot be the sole basis for a coverage denial |
| HHS OCR | Section 1557 Final Rule | July 2024 (algorithm provisions: compliance by May 2025) | Covered entities may not apply discriminatory algorithms in patient care decisions |

Table 6.2: Federal regulatory actions affecting clinical AI deployment at AMCs, 2024–2025 ([Office of the National Coordinator for Health Information Technology 2024](#ref-ONC2024-hti1); [U.S. Food and Drug Administration 2024](#ref-FDA2024-pccp); [Office of the Federal Register 2026](#ref-CFR422101); [Centers for Medicare and Medicaid Services 2024](#ref-CMS2024-mafaq); [U.S. Department of Health and Human Services, Office for Civil Rights 2024](#ref-HHS2024-1557))

The ONC HTI-1 rule is the most operationally significant for clinical informatics teams. It defines a new regulatory category — Decision Support Interventions — that includes EHR-based algorithms meeting specified criteria for automated decision-making. For each qualifying predictive tool, certified EHR vendors are required to make a defined set of source-attribute disclosures available to users: structured information about how the intervention was developed and how it performs, with the specific list enumerated in the certification criterion. The practical implication is that AMC clinical informatics leaders should be engaging their EHR vendor about DSI compliance now, and should verify that the source attributes being provided are substantive rather than boilerplate ([Office of the National Coordinator for Health Information Technology 2024](#ref-ONC2024-hti1)).
...
CMS’s application of the Medicare Advantage regulations to AI responds to documented cases of health insurers using AI-driven prior authorization systems to systematically deny claims with minimal human review. The regulation, 42 CFR 422.101(c), requires medical necessity determinations to rest on the individual patient’s circumstances, and CMS’s February 2024 memorandum states plainly that an algorithm determining coverage from a larger data set rather than the patient’s medical history, the treating physician’s recommendations, and the clinical notes does not comply. For AMC care management teams working with Medicare Advantage plans, this creates leverage: a plan that cites AI output as the basis for a clinical denial without demonstrable individualized review is operating out of compliance with CMS requirements ([Office of the Federal Register 2026](#ref-CFR422101); [Centers for Medicare and Medicaid Services 2024](#ref-CMS2024-mafaq)).
...
The practical governance recommendation is direct: any clinical AI tool that informs a treatment decision — as opposed to a purely administrative one — should be assessed against the FDA SaMD definition before deployment, and the assessment should be documented. Tools that qualify should be cleared through the appropriate regulatory pathway, structured to meet the clinical decision support exemption criteria — reassessed against FDA’s January 2026 revision of the CDS guidance, which widened the exemption for single-recommendation software, so assessments made under the 2022 guidance are worth redoing ([U.S. Food and Drug Administration 2026](#ref-FDA2026-cds)) — or restricted to research use until regulatory status is resolved ([U.S. Food and Drug Administration 2024](#ref-FDA2024-pccp)).
...
Adams, Roy, Katharine E Henry, Anirudh Sridharan, et al. 2022. “Prospective, Multi-Site Study of Patient Outcomes After Implementation of the TREWS Machine Learning-Based Early Warning System for Sepsis.” *Nature Medicine* 28 (7): 1455–60. <https://doi.org/10.1038/s41591-022-01894-0>.
...
American Medical Association. 2025. *Doctors Work Fewer Hours, but EHR Still Follows Them Home*. AMA. <https://www.ama-assn.org/practice-management/physician-health/doctors-work-fewer-hours-ehr-still-follows-them-home>.
...
Centers for Medicare and Medicaid Services. 2024. *Frequently Asked Questions Related to Coverage Criteria and Utilization Management Requirements in CMS Final Rule (CMS-4201-F)*. <https://www.cms.gov/files/document/hpms-memo-faq-coverage-criteria-and-utilization-management-cms-4201-f-02-6-2024-pdf.pdf>.
...
Henry, Katharine E, Roy Adams, Cassandra Parent, et al. 2022. “Factors Driving Provider Adoption of the TREWS Machine Learning-Based Early Warning System and Its Effects on Sepsis Treatment Timing.” *Nature Medicine* 28 (7): 1447–54. <https://doi.org/10.1038/s41591-022-01895-z>.
...
Office of the Federal Register. 2026. *42 CFR 422.101: Requirements Relating to Basic Benefits*. <https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-B/part-422/subpart-C/section-422.101>.
...
U.S. Food and Drug Administration. 2026. *Clinical Decision Support Software: Guidance for Industry and Food and Drug Administration Staff*. FDA-2017-D-6569. <https://www.fda.gov/regulatory-information/search-fda-guidance-documents/clinical-decision-support-software>.

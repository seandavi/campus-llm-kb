...
Across all these tools, the empirical literature on performance is sobering. A 2024 study in the *Journal of Medical Internet Research* asked large language models to reproduce the reference lists of published systematic reviews in orthopedic surgery: GPT-4 managed 13.4% precision and 13.7% recall against the references the human reviewers had actually included, and 28.6% of the citations it generated were hallucinated outright; for Bard the hallucination rate was 91.4% [@Chelli2024-llm-sr]. An earlier study found that blinded human reviewers failed to flag roughly a third of AI-generated medical abstracts as machine-written, even though those same abstracts sailed through plagiarism detectors with near-perfect originality scores [@Gao2023-chatgpt-abstracts]. These findings do not argue against using AI tools for literature work; they argue for using them as a first pass that a human reviews, not as a substitute for comprehensive search.

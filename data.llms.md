...
Figure 17.1: AMC AI data governance flow. Each gate represents a decision point requiring documented authorization. PHI that passes the honest broker gate is subject to BAA and zero-data-retention requirements throughout.

## 17.5 FHIR and OMOP as AI Substrate

The interoperability standards that AMCs have adopted for data exchange — [HL7 FHIR](https://hl7.org/fhir/) and the [OMOP Common Data Model](https://www.ohdsi.org/data-standardization/the-omop-common-data-model/) — are not just data formats. They are the substrate on which clinical AI is increasingly built and validated.

FHIR R5 provides standardized resource definitions for clinical data that allow AI models to query, retrieve, and write structured information across different EHR implementations. The SMART on FHIR authorization framework enables granular, patient-specific access scopes that are essential for the least-privilege agentic system design described in [sec-agentic-safety](#sec-agentic-safety). For AMCs procuring AI tools that need EHR interaction, FHIR compatibility is increasingly the minimum requirement — both for richer data access and for the access logging that governance requires.

The OMOP CDM is the dominant standard for large-scale observational research, and it has become the basis for multi-institutional AI validation ([Singhal et al. 2023](#ref-Singhal2023-medpalm)). A model validated on OMOP-formatted data from one institution can be tested against OMOP-formatted data from another without custom integration work. For AMCs participating in research consortia — NIH N3C, PCORnet, NIH Bridge2AI — OMOP compatibility is typically required.
...
The [Trusted Exchange Framework and Common Agreement](https://www.healthit.gov/topic/interoperability/trusted-exchange-framework-and-common-agreement-tefca) — TEFCA — established a network of [Qualified Health Information Networks](https://rce.sequoiaproject.org/qhin/) (QHINs) for nationwide clinical data exchange when it went live in 2023 ([Office of the National Coordinator for Health Information Technology 2023](#ref-TEFCA2023-common)). Epic’s Nexus Health Network, [Health Gorilla](https://www.healthgorilla.com), Oracle Health, and a handful of other organizations have received QHIN designation, creating for the first time a governed national pipe through which clinical data can flow across institutional boundaries.
...
Production federated learning infrastructure exists in healthcare. The NIH [Bridge2AI](https://bridge2ai.org) program is developing standardized data and AI-ready infrastructure across four large data generation projects, with federated coordination as a design principle ([National Institutes of Health 2023](#ref-Bridge2AI2023)). The [Medical Imaging and Data Resource Center](https://www.midrc.org) (MIDRC) has used federated learning to validate imaging AI models across multiple institutions without centralizing imaging data ([MIDRC Consortium 2024](#ref-MIDRC2024-federated)). [NVIDIA FLARE](https://nvflare.ai) is the dominant production framework for healthcare federated learning, with documented deployments at major academic medical centers.
...
**What it is:** A review of all current vendor agreements for AI tools handling PHI, assessing whether each BAA includes the provisions in [Table tbl-baa-checklist](#tbl-baa-checklist), combined with a draft institutional AI data governance policy operationalizing the classification framework and honest broker requirements above.
...
MIDRC Consortium. 2024. *Medical Imaging and Data Resource Center (MIDRC)*. [Https://www.midrc.org/](https://www.midrc.org/). <https://www.midrc.org/>.

National Institutes of Health. 2020. *Final NIH Policy for Data Management and Sharing (NOT-OD-21-013)*. [Https://grants.nih.gov/grants/guide/notice-files/NOT-OD-21-013.html](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-21-013.html). <https://grants.nih.gov/grants/guide/notice-files/NOT-OD-21-013.html>.

National Institutes of Health. 2023. *Bridge2AI: Generating AI-Ready Data for All*. [Https://commonfund.nih.gov/bridge2ai](https://commonfund.nih.gov/bridge2ai). <https://commonfund.nih.gov/bridge2ai>.

National Institutes of Health. 2025. *Guidance on Generative AI and Controlled-Access Human Genomic Data (NOT-OD-25-081)*. [Https://grants.nih.gov/grants/guide/notice-files/NOT-OD-25-081.html](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-25-081.html). <https://grants.nih.gov/grants/guide/notice-files/NOT-OD-25-081.html>.

Office of the National Coordinator for Health Information Technology. 2023. *Trusted Exchange Framework and Common Agreement (TEFCA), Common Agreement Version 1.1*. [Https://www.healthit.gov/tefca](https://www.healthit.gov/tefca). <https://www.healthit.gov/tefca>.
